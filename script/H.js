...
; ! function (factory) {
    if (typeof require === 'function' && typeof exports === 'object' && typeof module === 'object') {
        ...
        factory(window['H'] = {
            ...
            isDate: function (str) {
            	var dateRule = /^(?:(?:1[6-9]|[2-9][0-9])[0-9]{2}([-/.]?)(?:(?:0?[1-9]|1[0-2])\1(?:0?[1-9]|1[0-9]|2[0-8])|(?:0?[13-9]|1[0-2])\1(?:29|30)|(?:0?[13578]|1[02])\1(?:31))|(?:(?:1[6-9]|[2-9][0-9])(?:0[48]|[2468][048]|[13579][26])|(?:16|[2468][048]|[3579][26])00)([-/.]?)0?2\2(?:29))(\s+([01][0-9]:|2[0-3]:)?[0-5][0-9]:[0-5][0-9])?$/;
            	return dateRule.test(str);
            ...
            selectTip: function (element, items, okCallback, cancelCallback) {
                ...
                html += '<div class="H-select-list H-flexbox-vertical H-position-relative animated1 flipInY1">';
            ...
            toastCore: function (iconHTML, tipText, duration, animateName) {
                ...
                if (that.Ds("#H-toast-tip") && that.Ds("#H-toast-tip").length > 0) {
                    ...
                    that.addClass(toastDiv, "H-position-absolute H-z-index-1000000 H-height-100 H-width-100 H-border-radius-5 H-theme-background-color-black H-theme-font-color-white H-center-all H-text-align-center H-background-color-transparent-5 animateds " + animateName);
            ...
            //自定义提示--开始
            toastTip: function (msg,duration) {
                var that = this;
                mag = msg?msg:'提交成功';
                that.toastCore('<span class="H-display-block H-line-height-normal"><i class="H-iconfont H-icon-right H-font-size-42"></i></span>', mag, duration);
            },
            toastErr: function (msg,duration) {
                var that = this;
                mag = msg?msg:'提交失败';
                that.toastCore('<span class="H-display-block H-line-height-normal"><i class="H-iconfont H-icon-error H-font-size-42"></i></span>', mag, duration);
            },
              //自定义提示--结束
            ...
            toastLoading: function (msg,duration) {
                var that = this;
                msg = msg?msg:'加载中...';
                duration = Math.abs(that.isNumber(duration) ? Number(duration) : 10000);
                that.toastCore('<span class="H-display-block H-line-height-normal H-animate-rotate"><i class="H-iconfont H-icon-loading H-font-size-42"></i></span>', msg, duration);
            },
            closeToast: function () {
                var that = this;
                if (that.Ds("#H-toast-tip") && that.Ds("#H-toast-tip").length > 0) {
